...
export default class CarService {
    ...
    createCar = async (data: CreateCar, byUserId: number)=>{
        ...
        const car = await this.carRepository.createCar({...data, picture: pictureUrl}, byUserId)
        return car
    }
    ...
    updateCarById = async (id: number, data: UpdateCar, byUserId: number) => {
        ...
        const car = await this.carRepository.updateCarById(id,{...data, picture: pictureUrl}, byUserId)
        return car
    }
